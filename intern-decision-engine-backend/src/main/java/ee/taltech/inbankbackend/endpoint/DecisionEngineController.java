...
import ee.taltech.inbankbackend.service.LoanCalculator;
...
public class DecisionEngineController {
    ...
    private final LoanCalculator decisionEngine;
    private final DecisionResponse response;

    @Autowired
    DecisionEngineController(LoanCalculator decisionEngine, DecisionResponse response) {
